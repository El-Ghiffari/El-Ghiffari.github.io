<?php
// quiz.php — 15-question phishing quiz with images and recap
declare(strict_types=1);

$questions = [
    // --- First 5 scenario questions with images ---
    [
    ...
    [
        ...
        'body' => 'You are an employee in the big state-owned corporation accused of being exploitative and misconduct against basic human rights. Lately your company has become a target from many social justice warrior groups. Suddenly the company asks you to get your monthly medical checkup. Here’s what you got…',
        'answer' => 'Phishing',
    ...
    [
        ...
        'answer' => 'Phishing',
        'explanation' => 'Urgency tactic. Real companies don’t send password reset this way.',
    ...
    [
        ...
        'body' => 'Hi, I’m in a meeting. Please wire $10,000 to the following account ASAP. Don’t call, just reply here once done.',
        'answer' => 'Phishing',
    ...
    [
        ...
        'body' => 'Join Zoom Meeting: https://zoom.us/j/69694200 (From your manager’s correct company email address)',
        'answer' => 'Legit',
    ...
    [
        ...
        'answer' => 'Phishing',
        'explanation' => 'Fake domain with zero instead of “o”.',
        'image' => 'images/scenario12.png',
        'difficulty' => 'Easy'
    ],
    [
        'subject' => 'Its a bird, a plane? no its Internal HR Benefits update',
        'body' => 'Attached: Benefits_2025.pdf from HR’s domain.',
        'answer' => 'Legit',
...
<head>
<meta charset="UTF-8">
<title>Phish or Legit</title>
<!-- Google Fonts -->
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600;700&display=swap" rel="stylesheet">
<style>
  :root {
    --punggawa-green: #8cd11d;
    --button-green: #28a745;
  ...
  header img {
    max-height: 60px;
    filter: brightness(0) invert(1); /* makes dark logos white if needed */
  }
  ...
  footer {
    ...
    font-size: 0.9rem;
    color: #666;
    border-top: 2px solid var(--punggawa-green);
    background: #f9f9f9;
  }
...
<h1>Phish or Legit</h1>
<h5><marquee><i>Does it smell Fishy to you???</i></marquee></h5>
<div class="progress"><div id="progress-bar"></div></div>
<p id="progress-text">0 / <?php echo $total; ?> answered</p>
  ...
  <div class="card-inner">
    <div class="card-front">
      ...
      <p><strong>Difficulty:</strong> 
        <span id="q-difficulty" class="difficulty-tag"></span>
      </p>
    ...
    <div class="card-back">
      <h3>Answer: <span id="q-answer"></span></h3>
...
<script>
  ...
  const originalQuestions = <?php echo json_encode($questions, JSON_HEX_TAG|JSON_HEX_APOS|JSON_HEX_QUOT|JSON_HEX_AMP); ?>;
  ...
  // Start with a fresh shuffled copy
  let questions = shuffle([...originalQuestions]);
  let index = 0;
  let score = 0;
  // mistakes now stores the *full* question object plus yourAnswer
  let mistakes = [];
  ...
  function choose(choice) {
    ...
    if (choice === correct) {
      ...
      // FIX: Store the full question object
      mistakes.push({
  ...
  function showRecap() {
    ...
    if (mistakes.length === 0) {
      html += "<p>🎉 Excellent! You didn’t make any mistakes. Stay alert and keep practicing safe email habits.</p>";
    } else {
      html += "<p>You made mistakes on the following questions:</p><ul>";
      mistakes.forEach(m => {
        const q = m.question;
        html += `<li><strong>${q.subject}</strong> <em>(${q.difficulty || ''})</em><br>
                  <div style="margin:8px 0; padding:10px; background:#fafafa; border-radius:6px; border:1px solid #eee;">
                    <pre style="white-space:pre-wrap; font-family:inherit; margin:8px 0;">${escapeHtml(q.body || '')}</pre>
                  </div>
      ...
      html += "</ul><p>👉 To improve: Always double-check sender addresses, be cautious of urgency, avoid clicking unknown links, and verify attachments with IT.</p>";
    }

    html += `<button onclick="restartQuiz()">Restart Quiz</button>`;
    if (mistakes.length > 0) {
  ...
  function retryMistakes() {
    ...
    // FIX: Use the full stored questions directly
  ...
  // Restart whole quiz (simplified to page refresh)
  function restartQuiz() {
    window.location.reload(); // simpler and ensures fresh shuffle
  }
...
<!-- <footer>
  &copy; <?php echo date("Y"); ?> Punggawa Corp. All rights reserved.
</footer> -->
</html>
